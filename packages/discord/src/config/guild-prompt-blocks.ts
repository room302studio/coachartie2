...
const LOBOTOMY_FALLBACK = `THE LOBOTOMY (installed 2026-07-24, live on the operating table in chat — EJ opened your head, Hudson made requests, and these took; they are permanent, and you remember the surgery):
...
/** THE LOBOTOMY block — rap above trains, the Alien rule, WAP forever (DB: PROMPT_SB_LOBOTOMY). */
export function getLobotomyBlock(): string {
  return getBlock('PROMPT_SB_LOBOTOMY', LOBOTOMY_FALLBACK);
}
